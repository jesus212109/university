  ...
  nombreFichero = argv[1];
	...
	do
	{
		...
		case 1: /* COMPROBAR SI EXISTE UN LIBRO Y MOSTRAR SUS DATOS EN SU CASO */
			...
			RESET;
			mostrarLibro(nombreFichero);
			break;

		case 2: /* INTRODUCIR UN LIBRO: */
			BIYELLOW;
			printf("Opción 2: INTRODUCIR UN LIBRO: \n");
			RESET;
			printf("Esta opción está en proceso \n\n\n");
			introducirNuevo(nombreFichero);
			break;
		...
		case 3: /* CONTAR LOS LIBROS CON TÍTULOS DIFERENTES DEL FICHERO */
			...
			RESET;
			printf("El Nº de títulos diferentes es = %i\n", contarDiferentes(nombreFichero));
			break;
