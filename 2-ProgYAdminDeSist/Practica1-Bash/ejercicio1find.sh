...
archivos=$(find "$directorio" -type f) #Utilizo el comando find para obtener directamente las rutas de los archivos
#Al no ponerle flag me hace un listado de todos los elementos pero con su determinada ruta ( =ls pero con la ruta, no tan solo el nombre)
...
for archivo in $archivos; do
    ...
    while read -r linea; do # -r me va leyendo línea a línea
        ...
        let contador++
    done < "$archivo" #Vuelco el archivo para el read
done
